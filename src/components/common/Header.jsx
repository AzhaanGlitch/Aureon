        ...
        <div className="lg:hidden fixed top-20 left-0 right-0 z-40 mx-4 bg-black/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 overflow-hidden animate-[slideDown_0.3s_ease-out]">
          ...
          <div className="border-t border-white/10 p-4">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <p className="font-medium text-white text-sm">{user?.name || 'Azhaan Johnson'}</p>
                <p className="text-xs text-gray-400">{user?.email || 'Azhaan@email.com'}</p>
              </div>
            </div>
            ...
            <button className="w-full flex items-center space-x-2 px-4 py-2 text-left text-sm text-red-400 hover:bg-red-500/10 rounded-lg transition-colors duration-300">
              <LogOut size={16} />
              <span>Logout</span>
            </button>
          </div>
