      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-3">
            <span className="text-sm font-medium text-green-300">Step {step} of 4</span>
        ...
        <div className="bg-black/40 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-green-500/20">
          {step === 1 && (
            <div>
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-medium text-green-300 mb-3">Age</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-green-300 mb-3">Employment Status</label>
                ...
                <div>
                  ...
                  <div className="bg-gray-900/30 rounded-xl p-6 border border-green-500/20">
                    ...
                    />
                    <div className="text-center mt-4 text-4xl font-bold bg-gradient-to-r from-green-400 to-emerald-300 bg-clip-text text-transparent">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="8,500"
                      className="w-full pl-10 pr-4 py-4 bg-gray-900/50 border border-green-500/30 text-white placeholder-green-300/40 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition-all"
                    />
                  </div>
                </div>
          ...
          {step === 4 && (
            <div>
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-medium text-green-300 mb-4">
